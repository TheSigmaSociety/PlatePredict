        ...
        <div id="about" className="w-full min-h-screen flex items-center justify-center py-16">
            <div className="backdrop-blur-md bg-black/10 p-10 rounded-2xl shadow-lg w-11/12 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="backdrop-blur-sm bg-black/10 p-6 rounded-xl shadow-md border border-white/10 md:row-span-2 flex flex-col justify-center h-full">
                        <h3 className="text-4xl font-semibold mb-4 subtitle-color subtitle-font text-center">Our Mission</h3>
                        <p className="text-lg mb-6 text-font text-white font-bold">
                    ...
                    <div className="backdrop-blur-sm bg-black/10 p-6 rounded-xl shadow-md border border-white/10">
                        <h3 className="text-2xl font-semibold mb-4 subtitle-color subtitle-font text-center">How It Works</h3>
                        <ol className="text-font font-bold list-decimal list-inside space-y-3 text-lg text-white">
                    ...
                    <div className="backdrop-blur-sm bg-black/10 p-6 rounded-xl shadow-md border border-white/10">
                        ...
                        <ul className="text-white text-font font-bold list-disc list-inside space-y-2 text-lg">
